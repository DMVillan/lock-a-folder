...
#AutoIt3Wrapper_Res_Description=LocK-A-FoLdeR 3.6
...
Global Const $AppName = "LocK-A-FoLdeR",$AppVer = "3.6",$Apppage = "http://lock-a-folder.googlecode.com/",$updatefile = 'http://lock-a-folder.googlecode.com/files/Updates.ini'
